...
def parse_args():
    ...
    parser.add_argument("--data_name", type=str, default="tora")
    parser.add_argument("--prompt_type", type=str, default="tora")
    parser.add_argument("--file_path", type=str, default="/home/fan6/project/Tool/ToRA/data/tora/examples.jsonl")
